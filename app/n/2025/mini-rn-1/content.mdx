export const metadata = {
  title: '从零实现 React Native（1）: 桥通信的原理与实现',
  date: '2025-11-03',
  alternates: {
...
![React Native 桥架构示意图](/static/images/mini-rn-1/bridge-architecture.webp)
...
📝 本文首发于个人博客: https://zerosrat.dev/n/2025/mini-rn-1
